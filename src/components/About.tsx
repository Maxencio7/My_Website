      ...
      >
        ...
        >
          <div className="space-y-6 text-gray-300">
            <h3 className="text-2xl font-semibold text-[#00d2ff] mb-4">My Background</h3>
            <p>
            ...
            <h3 className="text-2xl font-semibold text-[#00d2ff] mb-4">My Approach</h3>
            <p>
            ...
            <h3 className="text-2xl font-semibold text-[#00d2ff] mb-4">My Mission</h3>
            <p>
